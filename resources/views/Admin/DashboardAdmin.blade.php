                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <form method="POST"
                                                    action="/admin/validasi-berita/{{ $item->id }}">
                                                    @csrf
                                                    @method('PUT')
        ...
        <div class="row mt-5">
            ...
            @php
                $programKerja = [
                    ...
                    // Tambahkan data program kerja lainnya
                    [
                        'judul' => 'Program Kerja',
                        'cabang' => 'HMI Cabang Maros',
                        'tanggal' => 'Rabu, 15 Desember 2023',
                ...
                $limit = 10; // Batasan jumlah program kerja yang ditampilkan
                $slicedProgramKerja = array_slice($programKerja, 0, $limit);
            @endphp
