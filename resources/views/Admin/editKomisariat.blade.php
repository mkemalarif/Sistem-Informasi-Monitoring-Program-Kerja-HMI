    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/{{ auth()->user()->jenisAkun }}/edit-komisariat/{{ $data->id }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input id="nokomisariat" type="text"
                                ...
                                value="{{ old('nokomisariat', $data->nokomisariat) }}" required autofocus>
                            @error('nokomisariat')
                        ...
                        <div class="form-group">
                            ...
                            <input id="namaKomisariat" type="text"
                                ...
                                value="{{ old('namaKomisariat', $data->namaKomisariat) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input id="tahunBerdiri" type="number"
                                ...
                                rows="3" required value="{{ old('tahunBerdiri', $data->tahunBerdiri) }}"></textarea>
                            @error('tahunBerdiri')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input id="angkatan" type="number"
                                ...
                                required value="{{ old('angkatan', $data->angkatan) }}"></textarea>
                            @error('angkatan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
